---
tldr: "Indexes the detail behind the grilling-with-options policy."
when_to_use: "Use when checking a question against the policy rather than composing one."
---
...
- [Validation](validation.md) — the checklist a drafted question passes before it is asked, and what makes one invalid.
