...
Governance has no per-run home the way a plan does, so a run appends one line to the `## Gate History` section of [`repo-governance/README.md`](../../README.md):

```markdown
## Gate History

- 2026-08-18 — strict — 2 cycles — pass
- 2026-09-02 — strict — 7 cycles — partial (1 contradiction open, AGENTS.md vs testing-policy.md)
```
...
**partial** — the loop ended with findings open. Each open finding is listed with its case and location.
