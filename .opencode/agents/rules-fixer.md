...
After any edit inside `.claude/`, `.codex/`, or `.opencode/`, run `npm run check:harness-parity`. It is the only automated proof that you left the harnesses equal. If it fails, revert your edit before continuing.
