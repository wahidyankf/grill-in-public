...
This directory contains human-facing documentation for Grind in Public: learning material, exercise guidance, and project concepts. AI-agent instructions belong in [`AGENTS.md`](../AGENTS.md) and related instruction files. Shared rules and governance procedures apply to people and agents, and belong in [`repo-governance/`](../repo-governance/).
