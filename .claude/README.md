...
This directory holds the Claude Code configuration for Grind in Public. Claude Code reads its repository rules from [`CLAUDE.md`](../CLAUDE.md), not from this directory; see the [agent harness support policy](../repo-governance/conventions/agent-harness-support.md).
