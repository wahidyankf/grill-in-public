...
Each skill is mirrored in [`.agents/skills/`](../../.agents/skills/README.md) and [`.opencode/skills/`](../../.opencode/skills/README.md) and must stay at parity; see the [harness capability parity policy](../../repo-governance/conventions/harness-capability-parity-policy.md).
