...
- `npm run check:markdown-links` validates every repository-local Markdown link;
  it runs on every pre-push. See the [commit hook policy](repo-governance/development/commit-hook-policy.md).
...
the [Nx workspace policy](repo-governance/development/nx-workspace-policy.md).
...
validation; follow the [Badak Mini policy](repo-governance/development/badakmini-cli-policy.md)
...
This learning repository requires extensive, purposeful code comments: explain
intent, flow, and non-obvious decisions without narrating syntax. See the
...
[testing policy](repo-governance/development/testing-policy.md).
...
see the [commit hook policy](repo-governance/development/commit-hook-policy.md). Keep pull
